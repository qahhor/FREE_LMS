# 🔧 Smartup LMS — Руководство по устранению неполадок

Подробное руководство по решению типичных проблем при развертывании и работе с Smartup LMS.
...
3. **Напишите на support@smartup.uz**
