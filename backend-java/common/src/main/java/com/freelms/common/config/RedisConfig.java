...
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("recommendations", defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigurations.put("search", defaultConfig.entryTtl(Duration.ofMinutes(3)));
